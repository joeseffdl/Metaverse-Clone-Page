      ...
      >
        <section className="h-full mt-10 ">
          ...
          <p className="text-md py-2 leading-8 text-gray-800">
            Even though I am currently working on my{" "}
            <span className="text-teal-600 font-semibold">Web Development</span>{" "}
            skills, I do have experience with the following technical skills
            such as:{" "}
            <span className="text-teal-600 font-semibold">
              Game Development, Mobile Development,{" "}
              <span className="text-black font-normal">and</span> Software
              Development
            </span>
          </p>
          <div
          ...
          >
            {[
              ...
              return (
                <div
                  className="basis-1/4 flex-1 shadow-lg p-6 rounded-xl bg-white text-center"
                  key={skill}
                >
                  <Image
