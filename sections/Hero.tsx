    ...
    >
      <div className="flex justify-center items-center flex-col relative z-10">
        ...
        >
          ...
          <div
            className={`md:w-[212px] sm:w-[80px] w-[60px] md:h-[108px] sm:h-[48px] h-[38px] md:border-[18px] border-[9px] rounded-r-[50px] border-white sm:mx-2 mx-[6px]`}
          />
          <h1
            className={`font-bold lg:text-[144px] md:text-[100px] sm:text-[60px] text-[44px] lg:leading-[158.4px] md:leading-[114.4px] sm:leading-[74.4px] leading-[64.4px] uppercase text-white`}
          >
      ...
      >
        <div className="absolute w-full h-[350px] hero-gradient rounded-tl-[140px] z-[0] sm:-top-10" />
