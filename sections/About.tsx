  ...
  <section className={`sm:p-16 xs:p-8 px-6 py-12 relative z-10`}>
    ...
    >
      ...
      <motion.p
        ...
        className="mt-2 w-5/6 sm:text-[28px] text-[20px] text-center text-white"
      >
        A self-taught full-stack developer with a passion for creating beautiful and functional web
